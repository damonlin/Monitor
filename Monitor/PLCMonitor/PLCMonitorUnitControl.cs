...
namespace Monitor
{
   public partial class PLCMonitorUnitControl : UserControl
   {
      private ArrayList plcUnitList = new ArrayList();
      /*
      ...
      */
      public PLCMonitorUnitControl()
      {
         InitializeComponent();
      }

      public int LoadUI(string iniFilePath)
      {         
         SuspendLayout();
         /*
